...
function metropolis_hastings_twostep{G <: Integer, T <: AbstractFloat}(
    ...
    S1GMArray, S1MArray, S1UArray, chgGM, chgM, chgU =
        metropolis_hastings_mixing(niter1, data, grows1, gcols1, GM0, M0, U0,
                                   ...
                                   transitionGM, transitionM, transitionU, nGM,
                                   nM, nU)
    ...
    dA = beta_mode.(M1, 3.0)
    mixtureM = [UnitKDEMixture(ukde, d, p) (ukde, d) in zip(ukdeM, dA)]
    ...
    for ii in 1:nsamples
        ...
        for (ii, (rr, cc)) in enumerate(zip(grows1, gcols1))
        ...
        S2GMArray, S2MArray, S2UArray, chgGM, chgM, chgU =
            metropolis_hastings_mixing(niter2, data, grows2, gcols2, exrows1, excols1,
                                       GMS20, M1, U1, lpGM, lpMS2, lpU,
                                       loglikelihood_datatable, transGMS2,
                                       transMGrid, transUGrid)
